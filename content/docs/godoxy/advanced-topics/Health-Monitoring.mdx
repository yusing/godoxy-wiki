...
- You can disable GoDoxy health probing by setting `healthcheck.disable: true` in the route file<sup className="font-bold">2</sup> or in the docker labels<sup className="font-bold">3</sup>. Docker health monitoring remains enabled for Docker routes.
