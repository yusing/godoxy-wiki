---
title: Short Links
description: Redirect short, memorable links to your services using the built-in `go/` shortlink feature
---
...
Wildcard aliases such as `*.example.com` are **not** registered as short links. Short links require a concrete destination hostname.
