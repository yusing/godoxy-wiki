---
title: Multi Docker Nodes
description: Setup multi docker nodes for GoDoxy
---
...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/yusing/godoxy/refs/heads/main/scripts/install-agent.sh)" -- update
```
