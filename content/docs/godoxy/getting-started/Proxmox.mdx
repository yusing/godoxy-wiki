...
description: Manage Proxmox VE PVE nodes and LXC containers with GoDoxy. This integration provides node-level monitoring, container lifecycle management, power operations, and resource monitoring
---
...
For more details, see [API Reference](/docs/openapi).
...
See [Idle Sleep](../advanced-topics/Idle-Sleep) for detailed configuration options.
