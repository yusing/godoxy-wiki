---
title: internal/net/gphttp/middleware/errorpage
description: Custom error page serving middleware that replaces default HTTP error responses with styled custom pages
---
