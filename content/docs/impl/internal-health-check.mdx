...
The transport scopes interception to the selected container-inspect endpoint so the
Docker client's API negotiation ping and other API responses pass through unchanged.
