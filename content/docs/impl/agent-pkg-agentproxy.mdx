---
title: agent/pkg/agentproxy
description: Package for configuring HTTP proxy connections through the GoDoxy Agent using HTTP headers
---
...
The `HTTPConfig` embedded type (from `internal/types`) includes:
