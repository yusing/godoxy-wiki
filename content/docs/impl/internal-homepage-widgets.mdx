---
title: internal/homepage/widgets
description: This package provides a widget framework for the GoDoxy homepage dashboard, enabling integration with various service providers to display real-time data
---
