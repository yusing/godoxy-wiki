...
- **Bare Metal**: Generates a one-liner that downloads and runs [`scripts/install-agent.sh`](https://github.com/yusing/godoxy/blob/main/scripts/install-agent.sh) via [`AgentEnvConfig.Generate()`](https://github.com/yusing/godoxy/blob/main/agent/pkg/agent/bare_metal.go#L27).
### 4. Fake Docker Host
