---
title: internal/net/gphttp/loadbalancer
...
```go
config := &lbconfig.Config{
    Link: "my-service",
    Mode: lbconfig.ModeRoundRobin,
}
...
The load balancer implements `health.HealthMonitor`:
