---
title: goutils/server
description: Server utilities for HTTP/HTTPS/HTTP3 server management
---
...
- HTTP/2 concurrent streams default to `32`; override with `HTTP2_MAX_CONCURRENT_STREAMS`
