---
title: internal/logging/memlogger
description: Provides a thread-safe in-memory circular buffer logger with WebSocket-based real-time streaming for log data
---
