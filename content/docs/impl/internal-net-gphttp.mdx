---
title: internal/net/gphttp
description: HTTP utilities package providing transport configuration, default HTTP client, and a wrapper around `http.ServeMux` with panic recovery
---
